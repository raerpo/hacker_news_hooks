...
},{"./cjs/react-dom.development.js":"../node_modules/react-dom/cjs/react-dom.development.js"}],"../src/api/index.ts":[function(require,module,exports) {
"use strict";
...
function useHNStoriesData(storiesIds, offset, range) {
  if (offset === void 0) {
    offset = 0;
  }
  ...
  react_1.useEffect(function () {
    for (var i = offset; i < range; i++) {
      fetch(API_URL + "item/" + storiesIds[i] + ".json").then(function (res) {
        return res.json();
      }).then(function (res) {
...
},{"react":"../node_modules/react/index.js"}],"../src/components/Story.tsx":[function(require,module,exports) {
"use strict";
...
var Story = function Story(_a) {
  var title = _a.title,
      url = _a.url,
      by = _a.by;
  return React.createElement("div", null, React.createElement("h3", null, React.createElement("a", {
    href: url
  }, title)), React.createElement("small", null, "by: ", by));
};
...
var App = function App() {
  var _a = api_1.useHNTopStories(),
      loading = _a.loading,
      stories = _a.stories;

  var storiesData = api_1.useHNStoriesData(stories, 0, 10);
  return React.createElement("div", null, React.createElement("h2", null, "Hackernew hooks"), loading && React.createElement("p", null, "Getting stories..."), storiesData && React.createElement("ul", null, storiesData.map(function (story) {
    return React.createElement("li", {
      key: story.time
    }, React.createElement(Story_1.default, story));
  })));
};

exports["default"] = App;
},{"react":"../node_modules/react/index.js","./api":"../src/api/index.ts","./components/Story":"../src/components/Story.tsx"}],"../src/index.tsx":[function(require,module,exports) {
"use strict";
...
},{"react":"../node_modules/react/index.js","react-dom":"../node_modules/react-dom/index.js","./App":"../src/App.tsx"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
