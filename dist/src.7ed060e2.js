...
},{"./cjs/react-dom.development.js":"../node_modules/react-dom/cjs/react-dom.development.js"}],"../src/api/index.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.useHNTopStories = useHNTopStories;
exports.useHNStoriesData = useHNStoriesData;
...
function useHNTopStories() {
  var _useState = (0, _react.useState)(null),
      _useState2 = _slicedToArray(_useState, 2),
      stories = _useState2[0],
      useStories = _useState2[1];

  var _useState3 = (0, _react.useState)(true),
      _useState4 = _slicedToArray(_useState3, 2),
      loading = _useState4[0],
      useLoading = _useState4[1];

  (0, _react.useEffect)(function () {
    fetch(API_URL + "topstories.json").then(function (res) {
      return res.json();
    }).then(function (res) {
      useLoading(false);
      useStories(res);
...
function useHNStoriesData(storiesIds) {
  var offset = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
  var range = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 20;

  var _useState5 = (0, _react.useState)([]),
      _useState6 = _slicedToArray(_useState5, 2),
      storiesData = _useState6[0],
      setStoriesData = _useState6[1];
  ...
  (0, _react.useEffect)(function () {
    for (var i = offset; i < range; i++) {
      fetch("".concat(API_URL, "item/").concat(storiesIds[i], ".json")).then(function (res) {
        return res.json();
      }).then(function (res) {
        return setStoriesData(function (stories) {
          return stories.concat(res);
        });
      });
    }
  }, []);
...
var Story = function Story(_ref) {
  var title = _ref.title,
      ...
      time = _ref.time,
      by = _ref.by;
  return _react.default.createElement("div", null, _react.default.createElement("h3", null, _react.default.createElement("a", {
    href: url
  }, title)), _react.default.createElement("small", null, "by: ", by));
};

var App = function App() {
  var _useHNTopStories = (0, _api.useHNTopStories)(),
      loading = _useHNTopStories.loading,
      stories = _useHNTopStories.stories;

  var storiesData = (0, _api.useHNStoriesData)(stories, 0, 20);
  return _react.default.createElement("div", null, _react.default.createElement("h2", null, "Hackernew hooks"), loading && _react.default.createElement("p", null, "Getting stories..."), storiesData && _react.default.createElement("ul", null, storiesData.map(function (story) {
    return _react.default.createElement("li", {
      key: story.time
    }, _react.default.createElement(Story, story));
  })));
};

var _default = App;
exports.default = _default;
},{"react":"../node_modules/react/index.js","./api":"../src/api/index.js"}],"../src/index.js":[function(require,module,exports) {
"use strict";
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "39057" + '/');
